...
const navItems = [
  ...
  { name: "Productos", path: "/productos", icon: <Coffee className="h-5 w-5" /> },
  ...
  { name: "Analíticas", path: "/analiticas", icon: <BarChart3 className="h-5 w-5" /> },
  { name: "POS", path: "/pos", icon: <ShoppingCart className="h-5 w-5" /> },
  { name: "Cocina", path: "/cocina", icon: <UtensilsCrossed className="h-5 w-5" /> },
  { name: "Facturas", path: "/facturas", icon: <FileText className="h-5 w-5" /> },
  { name: "Marketing", path: "/marketing", icon: <PackageOpen className="h-5 w-5" /> },
  { name: "Descuentos", path: "/descuentos", icon: <Percent className="h-5 w-5" /> },
  { name: "Pagos", path: "/pagos", icon: <Wallet className="h-5 w-5" /> },
  ...
  return (
    <div className="flex h-full flex-col bg-[#1c1c24] text-slate-300">
      ...
      <div className="mx-4 mb-4 flex items-center justify-between rounded-md bg-[#242430] px-3 py-2">
        <div className="text-sm font-medium text-white">Los Girasoles Resto</div>
