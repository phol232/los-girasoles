...
export function UnderConstruction() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <h1 className="mb-2 text-3xl font-bold tracking-tight">En construcción</h1>
      <p className="mb-6 max-w-md text-gray-500">
        La sección de <span className="font-medium text-orange-600">{getSectionTitle()}</span> está actualmente en desarrollo.
